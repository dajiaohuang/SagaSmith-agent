...
from nanobot.coc.db.campaigns import (
    CampaignAlreadyExistsError,
    CampaignNotFoundError,
    CampaignService,
)
from nanobot.ttrpg.db.base import Database
from nanobot.coc.db.module_content import ModuleImportError, ModuleImportService
...
@tool_parameters(
    {
        ...
        "properties": {
            ...
            "module_name": {"type": "string", "description": "Scenario module label or import name."},
            ...
            "rule_set_id": {
                "type": "string",
                "description": (
                    "Rule set ID for create/start (e.g. coc7-7e-srd). "
...
class Coc7CampaignTool(Tool):
    """Create, inspect, and manage CoC campaign lifecycles directly (no CLI subprocess)."""

    name = "coc7_campaign"
    description = (
        "Create and manage Call of Cthulhu campaigns in the campaign database. "
