...
from nanobot.coc.db.campaigns import CampaignNotFoundError
from nanobot.ttrpg.db.base import Database
from nanobot.coc.db.models.runtime import CampaignSave
from nanobot.coc.db.snapshots import (
...
class Coc7SaveTool(Tool):
    ...
    def create(cls, ctx: Any) -> Tool:
        ...
        if ctx.provider_snapshot_loader:
            try:
                ...
                from nanobot.coc.db.recap import RecapGenerator
        ...
        return cls(Database(system="coc7"), recap_generator=recap_generator)
    ...
    async def _generate_recap(self, campaign_id: str) -> dict | None:
        ...
        try:
            ...
            return {
                ...
                "language": "zh-CN",
                "summary": "Save complete, recap generation temporarily unavailable.",
    ...
    def _index_memory_actions(self, actions: list[dict] | None) -> None:
        ...
        if not revision_ids:
            return
        try:
            from nanobot.coc.memory_search import CampaignMemorySearchService
